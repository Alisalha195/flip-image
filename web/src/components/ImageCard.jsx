...
const ImageCard = ({ src,level, itemNumber, imagesBoard, setImagesBoard, showImageInBoard, index, compareSet, setCompareSet, waiting, setWaiting, allowPress, setAllowPress }) => {
